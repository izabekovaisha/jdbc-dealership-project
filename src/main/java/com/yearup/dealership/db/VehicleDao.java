...
public class VehicleDao {
    ...
    public List<Vehicle> searchByYearRange(int minYear, int maxYear) {
        ...
        try (Connection connection = dataSource.getConnection();
             PreparedStatement statement = connection.prepareStatement("SELECT * FROM vehicles WHERE year >= ? AND year <= ?")) {
            ...
            System.err.println("Error occurred while searching vehicles by year range: " + e.getMessage());
            e.printStackTrace();
        }
        return vehicles;
    }
    ...
    public List<Vehicle> searchByMileageRange(int minMileage, int maxMileage) {
        ...
        try (Connection connection = dataSource.getConnection();
             PreparedStatement statement = connection.prepareStatement("SELECT * FROM vehicles WHERE odometer >= ? AND odometer <= ?")) {
            ...
            System.err.println("Error occurred while searching vehicles by mileage range: " + e.getMessage());
            e.printStackTrace();
        }
        return vehicles;
    }
